...
class BaseLearningStrategy(ABC):
    def __init__(self, critic_model, optimizer, configuration: LearningStrategyConfiguration, running_mode = "eval",logger=None):
    ...
    def _disable_prior_gradients(self):
        ...
        self.critic_model.set_mode(self._running_mode)
