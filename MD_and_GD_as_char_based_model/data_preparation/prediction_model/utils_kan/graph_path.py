...
def atom_to_graph(smiles, encoder_atom, encoder_bond, force_field: str = 'mmff'):
    ...
    if Num_toms > 700:
        ...
        # Select and attempt the requested force field; fallback to alternatives if needed
        ok = False
...
def path_complex_mol(Smile, encoder_atom, encoder_bond, force_field: str = 'mmff'):
    g = atom_to_graph(Smile, encoder_atom, encoder_bond, force_field=force_field)
